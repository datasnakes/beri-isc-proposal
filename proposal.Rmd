...
While conda is a huge resource for anyone who needs to run analysis with R, beRi can serve as a helpful alternative in cases where direct access to CRAN, Bioconductor, or other parts of the R ecosystem is needed.
