...
[Team-beRi](https://github.com/orgs/datasnakes/teams/team-beri) is a group of indviduals who are passionate about reproducibility in science but have experienced the limitations of existing tools which support reproducible analyses with R. Bridging that gap was the motivation for prototyping beRi at hackseq18 and winning the popular votes exhibits that there is a strong interest and need for this tool in at least the bioinformatics community.
