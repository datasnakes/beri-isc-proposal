...
Conda is a well-developed and highly popular data science framework for package and environment management.  While it is similar to beRi, there are some key differences that set conda and beRi apart for managing the R language. 
...
Conda utilizes the Anaconda Cloud for package management.  At the time of writing, Anaconda [lists](https://docs.anaconda.com/anaconda/packages/r-language-pkg-docs/) 328 R packages available on Anaconda Cloud.  Bioconda is a third party repository for bioinformatics recipes for the Anaconda system.  While there are over 3000 Bioconductor recipes for the Ananconda system, there are only about 1,500 packages available on Bioconductor.
