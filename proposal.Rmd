...
Our target audience are those who can immediately benefit from better environment manangement in R, including computational researchers, data scientists, system administrators, and R package developers.
...
In its current iteration, rut can install packages from CRAN using R's remotes package. As the least developed package and most difficult to implement, rut will require more attention in order to develop it with best practices and integrate it with beRi. 
