...
offers access to a standard or custom package repository.  For example, Python has
[pip](https://pypi.org/project/pip/) for [PyPi](https://pypi.org/) or [conda](https://conda.io/docs/) for
