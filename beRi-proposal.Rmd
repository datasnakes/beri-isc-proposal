...
We are passionate about reproducible work in science, but have experienced the limitations of the existing tools that support reproducibility of analysis with R. Bridging that gap was the motivation for prototyping beRi at the hackseq hackathon, and winning the popular votes shows that there is a strong interest and need for this tool in at least the bioinformatics community.

We are familiar with Python, R, and Bash from our daily work, and plan to use these languages as the building blocks for the project. Some of us have software engineering experience to help with the development process. Since we will be both makers and users of this tool and are surrounded by fellow R users in science, we can continually improve beRi by adapting frequent feedbacks from ourselves and our community who will be the end users of beRi.
...
**Santina Lin** was a Master student in bioinformatics at the University of British Columbia. She used R for data analysis and visualization, and has taught R and statistics in a graduate level course as a teacher assistant. She is currently a software engineer at Microsoft and works on maintaining the RevoScaleR package and adding R and Python runtime to SQL server.
